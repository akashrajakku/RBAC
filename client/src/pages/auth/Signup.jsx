...
import { userSignup } from "../../services/admin/api";
...
export default function StylishSignupForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#f0f4f8] to-[#d9e2ec] flex items-center justify-center p-4">
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <h2 className="text-3xl font-bold bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 bg-clip-text text-transparent">
              Create Account
            </h2>
          ...
          <button
            ...
            className="w-full bg-gradient-to-r bg-purple-600 hover:bg-purple-700 text-white font-semibold py-4 px-6 rounded-2xl transition-all duration-200 transform hover:scale-[1.02] hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-purple-200 active:scale-[0.98]"
          >
          ...
          <button
            className="w-full text-center py-3 px-4 text-black transition-colors duration-200 text-sm font-medium"
          >
            Already have an account? 
            <span className="text-purple-600 hover:text-purple-700 ml-1 underline decoration-2 underline-offset-2 hover:cursor-pointer" onClick={siginHandler}>
              Sign in here
            </span>
          </button>
