import { addManager } from "../../services/manager/api";
        ...
        <div className="relative bg-white/80 rounded-3xl shadow-2xl w-full max-w-md mx-auto p-10 space-y-6 hover:shadow-3xl transition-all duration-300">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold">
              Add New <span className="bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 bg-clip-text text-transparent">Manager</span>
            </h2>
            <p className="text-gray-600">Fill in the manager details</p>
          </div>
          ...
          <div className="relative group">
            <input
              id="email"
              placeholder="e.g. manager1@gmail.com"
